<template>
  <div style="height: 485px">
    <h1 class="h1-create-edit">Edit Drink</h1>
      ...
      <div>
        <form class="form">
          ...
          <div>
            ...
            <button type="submit" class="submit" @click="editDrink">
              Submit
            </button>
          </div>
        </form>
...
export default {
  ...
  data() {
    return {
      form: {
        ...
        stock: this.drinks.stock,
        description: this.drinks.description,
      },
      drink: null,
    };
  },
  ...
  methods: {
    ...
    async editDrink() {
      await apiRequest.editDrinks({ ...this.form }).then(() => {
        this.$emit("changeDisplay", false);
      });
    },
  },
